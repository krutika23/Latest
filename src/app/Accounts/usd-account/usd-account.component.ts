...
@Component({
  ...
  templateUrl: './usd-account.component.html',
  styleUrls: ['./usd-account.component.css']
})
export class UsdAccountComponent implements OnInit {
    ...
    getAccDetails() {
        ...
        this.http.post('http://localhost:8082/Payment_Solution_and_Liquidity_Management/jaxrs/accDetails/usd', { test: 'test' }).subscribe(data => {
...
@Component({
    ...
    templateUrl: 'usd-dialog-box.html',
})
